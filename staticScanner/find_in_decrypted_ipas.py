...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--target", action="append", dest="targets", help="target to find")
    parser.add_argument("-f", "--targetfile", dest="targetfile", help="path to file listing targets")
    parser.add_argument("-i", "--indir", dest="indir", help="in which dir")
