...
def get_data_to_Tag_mapping(df):
    ...
    manully_label="./data/data_to_tag.xlsx"
    if os.path.exists(manully_label):
        ...
        manully_df.to_excel("./data/data_to_tag.xlsx")
...
def append_privacy_Label_incorr_inade(total_file,out_putfile):
    ...
    omit_df["send_data_tag"] = send_data_tag
...
if __name__ == '__main__':
    ...
    omitFile="../result/omitAppsResult_total_with_send_data_tag.xlsx"

    append_privacy_Label_incorr_inade(total_file, omitFile)
    '''
